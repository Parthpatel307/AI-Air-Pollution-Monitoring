...
function Login() {
  ...
  /*
   * Whenever the main Login page opens,
   * clear any previously active Firebase
   * login session.
   *
   * This prevents an old Citizen /
   * Authority account from opening
   * automatically.
   */
  useEffect(() => {
    if (!user) {
      ...
      <div className="access-grid">
        ...
        >
          ...
          <div className="access-card-content">
            ...
            <p>
              Review incidents, inspect
              citizen evidence, access AI
