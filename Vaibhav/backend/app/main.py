...
from app.routers.aqi import (
    router as aqi_router,
)
...
from app.routers.citizen_reports import (
...
from app.routers.hotspots import (
...
from app.routers.satellite import (
...
from app.websocket.aqi_socket import (
    router as ws_router,
)
...
app = FastAPI(
    title=
        "AI Air Pollution Monitoring API",
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://ai-air-pollution-monitoring-omega.vercel.app",
    ],

    allow_origin_regex=
        r"https://ai-air-pollution-monitoring(?:-[a-zA-Z0-9-]+)?\.vercel\.app",
